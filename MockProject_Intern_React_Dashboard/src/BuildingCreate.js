...
function BuildingCreate() {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post(`http://localhost:8081/api/building`, formData, {
            headers: {
                Authorization: token
            }
                    ...
                    <div className='row'>
                        ...
                        <div className="col-lg-6">
                            ...
                            <input
                                ...
                                className='form-control'
                            />
                            {errorMessages.street && <span className="text-danger">{errorMessages.street}</span>}
                        </div>
                        ...
                        <div className="col-lg-6">
                            ...
                            <input
                                ...
                                className='form-control'
                            />
                            {errorMessages.ward && <span className="text-danger">{errorMessages.ward}</span>}
                        </div>
                        ...
                        <div className="col-lg-6">
                            ...
                            {errorMessages.district && <span className="text-danger">{errorMessages.district}</span>}
                        </div>
                        ...
                        <div className="col-lg-3">
                            ...
                            <input
                                ...
                                className='form-control'
                            />
                            {errorMessages.priceDescription && <span className="text-danger">{errorMessages.priceDescription}</span>}
                        </div>
                        ...
                        <div className="col-lg-3">
                            ...
                            <input
                                ...
                                className='form-control'
                            />
                            {errorMessages.juridical && <span className="text-danger">{errorMessages.juridical}</span>}
                        </div>
                        ...
                        <div className="col-lg-3">
                            ...
                            {errorMessages.direction && <span className="text-danger">{errorMessages.direction}</span>}
                        </div>
                        ...
                        <div className="col-lg-3">
                            ...
                            <input
                                ...
                                className='form-control'
                            />
                            {errorMessages.bathRoom && <span className="text-danger">{errorMessages.bathRoom}</span>}
                        </div>
                        ...
                        <div className="col-lg-3">
                            ...
                            <input
                                ...
                                className='form-control'
                            />
                            {errorMessages.bedRoom && <span className="text-danger">{errorMessages.bedRoom}</span>}
                        </div>
                        ...
                        <div className="col-lg-3">
                            ...
                            <input
                                ...
                                className='form-control'
                            />
                            {errorMessages.area && <span className="text-danger">{errorMessages.area}</span>}
                        </div>
                        ...
                        <div className="col-lg-3">
                            ...
                            <input
                                ...
                                className='form-control'
                            />
                            {errorMessages.map && <span className="text-danger">{errorMessages.map}</span>}
                        </div>
                        ...
                        <div className='col-lg-3'>
                            ...
                            {errorMessages.isRent && <span className="text-danger">{errorMessages.isRent}</span>}
                        </div>
                        ...
                        <div className='col-lg-3'>
                            ...
                            {errorMessages.isSell && <span className="text-danger">{errorMessages.isSell}</span>}
                        </div>
                        ...
                        <div className='col-lg-12'>
                            ...
                            {errorMessages.categoryId && <span className="text-danger">{errorMessages.categoryId}</span>}
                        </div>
